...
export const PROGRAM_REGISTRY: ProgramEntry[] = [
  ...
  },
  {
    ...
    network: 'devnet',
    slabSizes: [62808],
    description: 'Percolator Launch — small tier (~240 accounts)',
  },
  {
    id: 'launch-medium',
    label: 'Launch Medium',
    ...
    network: 'devnet',
    slabSizes: [249480],
    description: 'Percolator Launch — medium tier (~960 accounts)',
  },
  {
    id: 'launch-large',
    label: 'Launch Large',
    ...
    network: 'devnet',
    slabSizes: [992560],
    description: 'Percolator Launch — large tier (~4096 accounts)',
  },
  {
    id: 'sov-mainnet',
    label: 'SOV Mainnet',
